...
exports.ttsMachine = (0, xstate_1.setup)({
    ...
    actors: {
        ...
        ponyfill: (0, xstate_1.fromCallback)(({ sendBack, input }) => {
            const ponyfill = (0, web_speech_cognitive_services_davi_1.default)({
                    ...
                    states: {
                                    ...
                                    states: {
                                        ...
                                        Speak: {
                                            ...
                                            states: {
                                                ...
                                                Go: {
                                                    id: "TtsStreamGo",
                                                    entry: ({ context }) => console.debug("[TTS] SPEAK (not cached): ", context.utteranceFromStream),
                                                    invoke: {
                                                        src: "start",
                                                        input: ({ context }) => ({
                        ...
                        Playing: {
                            ...
                            states: {
                                ...
                                PlayAudio: {
                                    entry: ({ context }) => console.debug("[TTS] SPEAK (cached): ", context.utteranceFromStream),
                                    invoke: {
                                        src: "playAudio",
                                        input: ({ context }) => ({
                                            audioContext: context.audioContext,
                        ...
                        Speaking: {
                            ...
                            states: {
                                Go: {
                                    entry: ({ context }) => console.debug("[TTS] SPEAK:", context.utteranceFromStream),
                                    invoke: {
                                        src: "start",
                                        input: ({ context }) => ({
                                            wsaTTS: context.wsaTTS,
