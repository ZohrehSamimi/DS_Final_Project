import { Agenda, TTSInit, TTSEvent, TTSContext, TTSPonyfillInput, ConstructableSpeechSynthesisUtterance } from "./types";
export declare const ttsMachine: import("xstate").StateMachine<TTSContext, TTSEvent, {
    ...
    readonly states: {
        ...
        readonly HandleNewTokens: {
            readonly initial: "Ponyfill";
            readonly states: {
                readonly Ponyfill: {
                    readonly invoke: {
                        readonly id: "ponyTTS";
