...
export declare const asrMachine: import("xstate").StateMachine<ASRContext, ASREvent, {
    ...
    params: unknown;
}, "noinputTimeout", "Ready" | "Fail" | "NLURequest" | {
    Recognising: "WaitForRecogniser" | "NoInput" | "InProgress" | "WaitToStop" | "Stopped" | {
    ...
    readonly context: ({ input }: {
        spawn: {
            <TSrc extends "new_ponyfill" | "nluPromise">(logic: TSrc, ...[options]: ({
                src: "new_ponyfill";
                logic: import("xstate").CallbackActorLogic<null, ASRPonyfillInput, import("xstate").EventObject>;
                id: string;
                ...
                readonly InProgress: {
                    ...
                    readonly on: {
                        readonly RECOGNISED: readonly [{
                            readonly target: "#asr.NLURequest";
                            readonly guard: {
        ...
        readonly NLURequest: {
            readonly invoke: {
                ...
                readonly onDone: readonly [{
                    readonly actions: readonly [({ event }: import("xstate").ActionArgs<ASRContext, import("xstate").DoneActorEvent<any, string>, ASREvent>) => void, import("xstate").ActionFunction<ASRContext, import("xstate").DoneActorEvent<any, string>, ASREvent, undefined, never, never, never, "noinputTimeout", never>, import("xstate").ActionFunction<ASRContext, import("xstate").DoneActorEvent<any, string>, ASREvent, undefined, never, never, never, "noinputTimeout", never>];
                ...
                readonly onError: {
                    readonly actions: readonly [({ event }: import("xstate").ActionArgs<ASRContext, import("xstate").ErrorActorEvent<unknown, string>, ASREvent>) => void, import("xstate").ActionFunction<ASRContext, import("xstate").ErrorActorEvent<unknown, string>, ASREvent, undefined, never, never, never, "noinputTimeout", never>, import("xstate").ActionFunction<ASRContext, import("xstate").ErrorActorEvent<unknown, string>, ASREvent, undefined, never, never, never, "noinputTimeout", never>];
                    readonly target: "Ready";
                };
            };
        };
